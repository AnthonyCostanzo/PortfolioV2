  ...
  return (
    <Layout>
      <div className="relative h-screen bg-gray-900 ">
        ...
        <div className="items-center mt-2 flex h-1/3 font-bold  z-1 mx-4 md:ml-8 md:mt-8 md:h-1/2 text-[28px] lg:text-[40px] ">
          <div className={`${styles.wrapper} text-gray-100 flex flex-col`}>
            ...
            <ul className={`${styles.dynamic} text-[32px]  text-[#f2f2f2]`}>
              <li>
